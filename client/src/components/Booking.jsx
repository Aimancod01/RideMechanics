...
const Booking = () => {
  ...
  useEffect(() => {
    ...
    } // Generate random dates and times if not found
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="px-6 py-4">
              ...
              <h2 className="text-gray-800 text-2xl font-bold mb-2 flex items-center">
                ...
                {displayData.city || 'Lahore'}</h2>
              <div className="space-y-1">
                <p className="  flex items-cente">
                <Calendar className="h-5 w-5 text-orange-500 mr-2" />
                  Pickup: {displayData.pickupDate || ' 2024-11-23T19:00:00.000Z '} at   <Clock className="h-5 w-5 text-orange-500 mx-2" />{displayData.pickupTime || '07:00 AM'}</p>
                <p className="  flex items-cente">  
                <Calendar className="h-5 w-5 text-orange-500 mr-2" />
                  Drop-off: {displayData.dropoffDate || '2024-11-25T19:00:00.000Z'} at    <Clock className="h-5 w-5 text-orange-500 mx-2" />{displayData.dropoffTime ||'07:00 AM' }</p>
              </div>
            </div>
          </div>
